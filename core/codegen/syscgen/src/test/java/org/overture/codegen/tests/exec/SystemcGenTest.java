...
public class SystemcGenTest extends SystemcGenTestBase
{
	public SystemcGenTest(String name, File vdmSpec, TestHandler testHandler)
	{
	...
	{
		return collectTests(new File(ClassicOutputTest.ROOT), new ExecutableSpecTestHandler(Release.CLASSIC, Dialect.VDM_RT));
	}
