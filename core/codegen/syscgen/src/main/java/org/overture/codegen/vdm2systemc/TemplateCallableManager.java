...
{
    private static final String SYSTEMC_FORMAT_KEY = "SystemcFormat";
    ...
    public final static TemplateCallable[] constructTemplateCallables(
            Object systemcFormat, Object valueSemantics)
    {
        return new TemplateCallable[] {
                new TemplateCallable(SYSTEMC_FORMAT_KEY, systemcFormat),
